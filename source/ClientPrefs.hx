...
class ClientPrefs {
	...
	public static var timeBarType:String = 'Time left and Time Elapsed';
	//public static var cacheOnGPU:Bool = false; //From Stilic
	public static var scoreZoom:Bool = true;
	public static var noReset:Bool = false;
	public static var healthBarAlpha:Float = 1;
	public static var laneUnderlay:Float = 0;
	public static var isEnemy:Bool = false;
