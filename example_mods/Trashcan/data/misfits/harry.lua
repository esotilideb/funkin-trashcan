...
idleOffsets = {'45', '52'}        -- I recommend you have your idle offset at 0
leftOffsets = {'90', '47'}
downOffsets = {'137', '35'}
upOffsets = {'14', '109'}
rightOffsets = {'-67', '63'}
...
idle_xml_name = 'HarryIdle0'
left_xml_name = 'HarryLeft0'
down_xml_name = 'HarryDown0'
up_xml_name = 'HarryUp0'
right_xml_name = 'HarryRight0'
...
name_of_character_xml = 'harry'
name_of_character = 'harry'
charNote = 'harry'
charNote2 = 'novies'    -- to distinguish between multiple characters singing at the same time (uncomment to use)
...
function onBeatHit()
    ...
    if curStep == 1182 or curStep == 1450 or curStep == 1538 then
...
function onUpdate(elapsed)
    if curStep == 1189 or curStep == 1452 or curStep == 1540 then
        objectPlayAnimation(name_of_character, 'idle', false);
        setProperty(name_of_character .. '.offset.x', idleOffsets[1]);
        setProperty(name_of_character .. '.offset.y', idleOffsets[2]);
    end
